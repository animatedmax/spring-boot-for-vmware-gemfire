...
``` highlight
# Spring Boot application.properties for the VMware GemFire ClientCache application
...
``` highlight
# Spring Boot application.properties for the VMware GemFire ClientCache One application.
